...
PRODUCT_BUILD_PROP_OVERRIDES += PRODUCT_NAME=droid2we_vzw BUILD_ID=S273 BUILD_DISPLAY_ID=VZW BUILD_FINGERPRINT=verizon/droid2we_vzw/cdma_droid2we:2.3.3/4.5.1_57_D2G-36/110713:user/release-keys PRIVATE_BUILD_DESC="cdma_droid2we-user 2.3.3 4.5.1_57_D2G-36 110713 release-keys" TARGET_DEVICE=cdma_droid2we PRODUCT_BRAND=verizon BUILD_NUMBER=4.5.1_57_D2G-36 BUILD_UTC_DATE=1287722464 TARGET_BUILD_TYPE=user BUILD_VERSION_TAGS=release-keys USER=xrpk47
